...
#SBATCH --job-name=lods_per_gene_ext     # Job name
...
#SBATCH --output=lods_per_gene_ext_%A-%a.out # Standard output and error log
...
singularity exec --bind $data_dir:/app/qtl2rest/data/rdata --bind $db_file:/app/qtl2rest/data/sqlite/ccfounders.sqlite $container Rscript $r_script $dataset $ext_file $start_idx $end_idx
